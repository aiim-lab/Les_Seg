...
my_generator= trainGenerator(2, os.path.join(os.getcwd(),'data', 'train'),'image','label',data_gen_args, save_to_dir= None)
...
testGene = testGenerator(os.path.join(os.getcwd(),'data','validation'))
results = model.predict_generator(testGene,30,verbose=1)
saveResult(os.path.join(os.getcwd()),results)
